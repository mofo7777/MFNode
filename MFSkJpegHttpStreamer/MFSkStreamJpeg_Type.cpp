...
HRESULT CMFSkStreamJpeg::IsMediaTypeSupported(IMFMediaType* pMediaType, IMFMediaType** ppMediaType){

		TRACE_STREAM((L"JpegStream::IsMediaTypeSupported"));
		...
		IF_FAILED_RETURN(hr = (SubType != MFVideoFormat_MJPG ? MF_E_INVALIDTYPE : S_OK));
...
HRESULT CMFSkStreamJpeg::GetMediaTypeCount(DWORD* pdwTypeCount){

		TRACE_STREAM((L"JpegStream::GetMediaTypeCount"));
...
HRESULT CMFSkStreamJpeg::GetMediaTypeByIndex(DWORD dwIndex, IMFMediaType** ppType){

		TRACE_STREAM((L"JpegStream::GetMediaTypeByIndex"));
		...
		try{
				...
				IF_FAILED_THROW(hr = pType->SetGUID(MF_MT_SUBTYPE, MFVideoFormat_MJPG));
...
HRESULT CMFSkStreamJpeg::SetCurrentMediaType(IMFMediaType* pMediaType){

		TRACE_STREAM((L"JpegStream::SetCurrentMediaType"));
...
HRESULT CMFSkStreamJpeg::GetCurrentMediaType(IMFMediaType** ppMediaType){

		TRACE_STREAM((L"JpegStream::GetCurrentMediaType"));
...
HRESULT CMFSkStreamJpeg::GetMajorType(GUID* pguidMajorType){

		TRACE_STREAM((L"JpegStream::GetMajorType"));
