...
HRESULT CStreamDxva2Renderer::IsMediaTypeSupported(IMFMediaType* pMediaType, IMFMediaType** ppMediaType){
	...
	// MFVideoFormat_NV12 MFVideoFormat_YV12
	IF_FAILED_RETURN(hr = (MajorType != MFMediaType_Video ? MF_E_INVALIDTYPE : S_OK));
	IF_FAILED_RETURN(hr = (SubType != MFVideoFormat_NV12 ? MF_E_INVALIDTYPE : S_OK));
...
HRESULT CStreamDxva2Renderer::GetMediaTypeCount(DWORD* pdwTypeCount){
...
HRESULT CStreamDxva2Renderer::GetMediaTypeByIndex(DWORD dwIndex, IMFMediaType** ppType){
	...
	try{
		...
		// MFVideoFormat_NV12 MFVideoFormat_YV12
		IF_FAILED_THROW(hr = pType->SetGUID(MF_MT_SUBTYPE, MFVideoFormat_NV12));
...
HRESULT CStreamDxva2Renderer::SetCurrentMediaType(IMFMediaType* pMediaType){
...
HRESULT CStreamDxva2Renderer::GetCurrentMediaType(IMFMediaType** ppMediaType){
...
HRESULT CStreamDxva2Renderer::GetMajorType(GUID* pguidMajorType){
