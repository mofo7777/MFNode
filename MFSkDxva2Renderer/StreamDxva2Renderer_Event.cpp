...
HRESULT CStreamDxva2Renderer::GetEvent(DWORD dwFlags, IMFMediaEvent** ppEvent){
...
HRESULT CStreamDxva2Renderer::BeginGetEvent(IMFAsyncCallback* pCallback, IUnknown* punkState){
...
HRESULT CStreamDxva2Renderer::EndGetEvent(IMFAsyncResult* pResult, IMFMediaEvent** ppEvent){
...
HRESULT CStreamDxva2Renderer::QueueEvent(MediaEventType met, REFGUID guidExtendedType, HRESULT hrStatus, const PROPVARIANT* pvValue){
