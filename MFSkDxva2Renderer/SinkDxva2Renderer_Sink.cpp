...
HRESULT CSinkDxva2Renderer::GetCharacteristics(DWORD* pdwCharacteristics){
...
HRESULT CSinkDxva2Renderer::AddStreamSink(DWORD /*dwStreamSinkIdentifier*/, IMFMediaType* /*pMediaType*/, IMFStreamSink** /*ppStreamSink*/){

		TRACE_SINK((L"SinkRenderer::AddStreamSink"));
		return MF_E_STREAMSINKS_FIXED;
}

HRESULT CSinkDxva2Renderer::RemoveStreamSink(DWORD /*dwStreamSinkIdentifier*/){

		TRACE_SINK((L"SinkRenderer::RemoveStreamSink"));
		return MF_E_STREAMSINKS_FIXED;
}

HRESULT CSinkDxva2Renderer::GetStreamSinkCount(DWORD* pcStreamSinkCount){
...
HRESULT CSinkDxva2Renderer::GetStreamSinkByIndex(DWORD dwIndex, IMFStreamSink** ppStreamSink){
		...
		*ppStreamSink = m_pStreamDxva2Renderer;
		(*ppStreamSink)->AddRef();

		return hr;
}

HRESULT CSinkDxva2Renderer::GetStreamSinkById(DWORD dwStreamSinkIdentifier, IMFStreamSink** ppStreamSink){
...
HRESULT CSinkDxva2Renderer::SetPresentationClock(IMFPresentationClock* pPresentationClock){
...
HRESULT CSinkDxva2Renderer::GetPresentationClock(IMFPresentationClock** ppPresentationClock){
...
HRESULT CSinkDxva2Renderer::Shutdown(){
		...
		if(m_pStreamDxva2Renderer){
				IF_FAILED_RETURN(hr = m_pStreamDxva2Renderer->Shutdown());
				SAFE_RELEASE(m_pStreamDxva2Renderer);
		}
