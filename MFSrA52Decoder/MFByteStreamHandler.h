...
public:
	...
	STDMETHODIMP GetMaxNumberOfBytesRequiredForResolution(QWORD*){ TRACE_HANDLER((L"ByteStream::GetMaxNumberOfBytes")); return E_NOTIMPL; }
...
private:
	...
	CMFByteStreamHandler() : m_nRefCount(1), m_pResult(NULL), m_pSource(NULL){ TRACE_HANDLER((L"ByteStream::CTOR")); }
	virtual ~CMFByteStreamHandler(){ TRACE_HANDLER((L"ByteStream::DTOR")); SAFE_RELEASE(m_pSource); SAFE_RELEASE(m_pResult); }

	volatile long m_nRefCount;

	IMFAsyncResult* m_pResult;
	CMFA52Source* m_pSource;
};
