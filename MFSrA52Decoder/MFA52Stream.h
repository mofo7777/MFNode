...
class CMFA52Stream : BaseObject, public IMFMediaStream{

public:

	static HRESULT CreateInstance(CMFA52Stream**, CMFA52Source*, IMFStreamDescriptor*, HRESULT&);
...
private:
	...
	CMFA52Stream(CMFA52Source*, IMFStreamDescriptor*, HRESULT&);
	virtual ~CMFA52Stream(){ TRACE_STREAM((L"Stream::DTOR")); Shutdown(); }
