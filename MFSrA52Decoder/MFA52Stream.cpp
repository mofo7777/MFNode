...
CMFA52Stream::CMFA52Stream(CMFA52Source* pSource, IMFStreamDescriptor* pSD, HRESULT& hr)
	: m_nRefCount(1),
	m_pEventQueue(NULL),
...
HRESULT CMFA52Stream::CreateInstance(CMFA52Stream** ppStream, CMFA52Source* pSource, IMFStreamDescriptor* pSD, HRESULT& hr){
	...
	CMFA52Stream* pStream = new (std::nothrow)CMFA52Stream(pSource, pSD, hr);
...
HRESULT CMFA52Stream::QueryInterface(REFIID riid, void** ppv){

	TRACE_STREAM((L"Stream::QI : riid = %s", GetIIDString(riid)));

	static const QITAB qit[] = {
			QITABENT(CMFA52Stream, IMFMediaEventGenerator),
			QITABENT(CMFA52Stream, IMFMediaStream),
			{ 0 }
	};
...
HRESULT CMFA52Stream::BeginGetEvent(IMFAsyncCallback* pCallback, IUnknown* punkState){
...
HRESULT CMFA52Stream::EndGetEvent(IMFAsyncResult* pResult, IMFMediaEvent** ppEvent){
...
HRESULT CMFA52Stream::GetEvent(DWORD dwFlags, IMFMediaEvent** ppEvent){
...
HRESULT CMFA52Stream::QueueEvent(MediaEventType met, REFGUID guidExtendedType, HRESULT hrStatus, const PROPVARIANT* pvValue){
...
HRESULT CMFA52Stream::GetMediaSource(IMFMediaSource** ppMediaSource){
...
HRESULT CMFA52Stream::GetStreamDescriptor(IMFStreamDescriptor** ppStreamDescriptor){
...
HRESULT CMFA52Stream::RequestSample(IUnknown* pToken){
